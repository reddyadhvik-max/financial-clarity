#!/usr/bin/env python3
"""SNAPSHOT COPY for review — the version that actually runs is scripts/e2e_smoke.py
at the repo root (it locates backend/data/sample_offers.json relative to its own
path, which only resolves correctly from there). Run it from there, not this copy.
