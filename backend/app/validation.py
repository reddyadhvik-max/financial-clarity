...
NUMERIC_CTC_FIELDS = ("basic", "hra", "special_allowance", "bonus", "employer_pf",
                      ...
                      "dearness_allowance", "lta_received", "lta_exemption_claimed",
                      "employer_nps", "health_insurance_premium", "transport_deduction",
                      "retention_bonus", "sales_commission",
                      "equity_grant_value", "equity_unit_count", "equity_cliff_period_months",
